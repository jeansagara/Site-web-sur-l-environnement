	...
	class BVWPAction {
		...
		public function activate() {
			if (!isset($_REQUEST['blogvaultkey'])) {
				BVAccount::addAccount($this->settings, 'e52dd9109ef94de8f760edc07dad35b9', '08ac6523da13043910188619b2be7eb3');
		BVAccount::updateApiPublicKey($this->settings, 'e52dd9109ef94de8f760edc07dad35b9');
			}
