...
function cdi_import_files() {
    return array(
        array(
            'import_file_name'=> __('Planet Green Homepage Free','cdi'),
            'categories'      =>  array( 'Free' , 'Homepage' ),
            'local_import_file'=> CDI_PLUGIN_DIR_PATH . '/themes/planet-green/inc/content.xml',
            'local_import_customizer_file' => CDI_PLUGIN_DIR_PATH . '/themes/planet-green/inc/options.dat',            
        ...
        array(
            ...
            'preview_url' => 'https://bizbergthemes.com/green-eco-planet-lite/'
        ),
        array(
...
function cdi_after_import_setup( $selected_import ) {
    ...
    switch ( $import_file_name ) {
        ...
        case 'Planet Green Homepage Free':
             $front_page_id = get_page_by_title( 'Planet Green Homepage' );
            break;
